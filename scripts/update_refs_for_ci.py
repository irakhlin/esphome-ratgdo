...
RATGDO_REPO = "irakhlin/esphome-ratgdo"
...
def main():
    ...
    for yaml_file in project_root.glob("*.yaml"):
        ...
        if "remote_package:" in content and "irakhlin/esphome-ratgdo" in content:
